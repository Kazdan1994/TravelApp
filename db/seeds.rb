...
Destination.create(name: "El Castillo", description: "An elite destinations famous for its white sand beaches", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach04.jpg", tag_id: t1.id)
